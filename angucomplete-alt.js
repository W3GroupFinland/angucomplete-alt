...
(function (root, factory) {
  ...
  angular.module('angucomplete-alt', [] )
    ...
    $templateCache.put(TEMPLATE_URL,
        ...
        '  <input id="{{id}}_value" name="{{inputName}}" ng-model="searchStr" ng-disabled="disableInput" type="{{type}}" placeholder="{{placeholder}}" ng-focus="onFocusHandler()" class="{{inputClass}}" ng-focus="resetHideResults()" ng-blur="hideResults($event)" autocapitalize="off" autocorrect="off" autocomplete="off" ng-change="inputChangeHandler(searchStr)"/>' +
